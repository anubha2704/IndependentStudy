...
label = pd.read_csv("labeled.csv",sep=',')

print("read unLabeled Data")
unlabel = pd.read_csv("unlabeled.csv",sep=',')
...
print("save labeled")
with open("labeledClean.tsv",'w',encoding="utf-8") as write_csv:
    write_csv.write(label.to_csv(sep='\t', index=False))

print("save unlabeled")    
with open("unlabeledClean.tsv",'w',encoding="utf-8") as write_csv:
